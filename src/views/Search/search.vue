		...
		<div class="all_content">
		 <div class="images_content">
			   ...
			   <div class="search_words">
			     搜索关键词： 
			    <span style="color: rgb(0, 158, 251);">{{keyword}}</span> 共 
			    <span style="color: rgb(0, 158, 251);">{{total}}</span> 张 
			   </div>
...
<script>
	...
	import { searchImg,collection,download2} from "_api/api";
	export default {
		components: {
			Header,
		    Footer
